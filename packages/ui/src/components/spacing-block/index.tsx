...
const spacingBlockVariants = cva('', {
  variants: {
    width: {
      default: '',
      [SpacingBlockVariants['0.25']]: 'w-1r',
      [SpacingBlockVariants['0.5']]: 'w-2r',
      [SpacingBlockVariants['0.75']]: 'w-3r',
      [SpacingBlockVariants['1']]: 'w-4r',
      [SpacingBlockVariants['1.25']]: 'w-5r',
      [SpacingBlockVariants['1.5']]: 'w-6r',
      [SpacingBlockVariants['1.75']]: 'w-7r',
      [SpacingBlockVariants['2']]: 'w-8r',
      [SpacingBlockVariants['2.25']]: 'w-9r',
      [SpacingBlockVariants['2.5']]: 'w-10r',
      [SpacingBlockVariants['2.75']]: 'w-11r',
    ...
    height: {
      default: '',
      [SpacingBlockVariants['0.25']]: 'h-1r',
      [SpacingBlockVariants['0.5']]: 'h-2r',
      [SpacingBlockVariants['0.75']]: 'h-3r',
      [SpacingBlockVariants['1']]: 'h-4r',
      [SpacingBlockVariants['1.25']]: 'h-5r',
      [SpacingBlockVariants['1.5']]: 'h-6r',
      [SpacingBlockVariants['1.75']]: 'h-7r',
      [SpacingBlockVariants['2']]: 'h-8r',
      [SpacingBlockVariants['2.25']]: 'h-9r',
      [SpacingBlockVariants['2.5']]: 'h-10r',
      [SpacingBlockVariants['2.75']]: 'h-11r',
    ...
    size: {
      default: '',
      [SpacingBlockVariants['0.25']]: 'w-1r h-1r',
      [SpacingBlockVariants['0.5']]: 'w-2r h-2r',
      [SpacingBlockVariants['0.75']]: 'w-3r h-3r',
      [SpacingBlockVariants['1']]: 'w-4r h-4r',
      [SpacingBlockVariants['1.25']]: 'w-5r h-5r',
      [SpacingBlockVariants['1.5']]: 'w-6r h-6r',
      [SpacingBlockVariants['1.75']]: 'w-7r h-7r',
      [SpacingBlockVariants['2']]: 'w-8r h-8r',
      [SpacingBlockVariants['2.25']]: 'w-9r h-9r',
      [SpacingBlockVariants['2.5']]: 'w-10r h-10r',
      [SpacingBlockVariants['2.75']]: 'w-11r h-11r',
